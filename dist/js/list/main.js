...
/* @source modules/del_tally/model.js */;

define("modules/del_tally/model", [
  "js/models/base"
], function(Base) {
...
/* @source modules/del_tally/view.js */;

define("modules/del_tally/view", [
  "js/views/base"
], function(Base) {
...
/* @source modules/del_tally/index.js */;

define("modules/del_tally/index", [
  "modules/del_tally/view",
  "modules/del_tally/model"
], function(View, Model) {
  return {
    init: function() {
      var view = new View({
...
/* @source js/list/modules.js */;

define("js/list/modules", [
  "js/common/moduleRunner",
  "modules/del_tally/index",
  "modules/headbar/index"
], function(ModuleRunner, del_tally, headbar) {
    var modules = {
        del_tally: del_tally,
        headbar: headbar
    };
...
require(['js/list/modules'], function() {});