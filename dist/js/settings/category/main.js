...
/* @source modules/del_category/model.js */;

define("modules/del_category/model", [
  "js/models/base"
], function(Base) {
...
/* @source modules/del_category/view.js */;

define("modules/del_category/view", [
  "js/views/base"
], function(Base) {
...
/* @source modules/del_category/index.js */;

define("modules/del_category/index", [
  "modules/del_category/view",
  "modules/del_category/model"
], function(View, Model) {
  return {
    init: function(el) {
      var view = new View({
...
/* @source js/settings/category/modules.js */;

define("js/settings/category/modules", [
  "js/common/moduleRunner",
  "modules/del_category/index",
  "modules/headbar/index"
], function(ModuleRunner, del_category, headbar) {
    var modules = {
...
require(['js/settings/category/modules'], function() {});