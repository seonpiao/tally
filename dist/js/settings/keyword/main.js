...
/* @source modules/del_keyword/model.js */;

define("modules/del_keyword/model", [
  "js/models/base"
], function(Base) {
...
/* @source modules/del_keyword/view.js */;

define("modules/del_keyword/view", [
  "js/views/base"
], function(Base) {
...
/* @source modules/del_keyword/index.js */;

define("modules/del_keyword/index", [
  "modules/del_keyword/view",
  "modules/del_keyword/model"
], function(View, Model) {
  return {
    init: function(el) {
      var view = new View({
...
/* @source js/settings/keyword/modules.js */;

define("js/settings/keyword/modules", [
  "js/common/moduleRunner",
  "modules/del_keyword/index",
  "modules/headbar/index"
], function(ModuleRunner, del_keyword, headbar) {
    var modules = {
...
require(['js/settings/keyword/modules'], function() {});